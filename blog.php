       ...
       <main>
        <div class="container margin_60_35">
            <div class="row">
                <div class="col-md-9">
                        <div class="post">
                        <figure class="animated"><a href="blog_post.html" title="blog_post.html"><img src="img/blog-3.jpg" alt="" class="img-responsive"></a></figure>
                    ...
                    <div class="post">
						<figure class="animated"><a href="blog_post.html" title="blog_post.html"><img src="img/blog-1.jpg" alt="" class="img-responsive"></a></figure>
                        <div class="post_info clearfix">
                            <div class="post-left">
                                <ul>
                                    <li><i class="icon-calendar-empty"></i> On <span>12 Nov 2020</span></li>
                    ...
                    <div class="post">
						<figure class="animated"><a href="blog_post.html" title="blog_post.html"><img src="img/blog-2.jpg" alt="" class="img-responsive"></a></figure>
                        <div class="post_info clearfix">
                            <div class="post-left">
                                <ul>
                                    <li><i class="icon-calendar-empty"></i> On <span>12 Nov 2020</span></li>
